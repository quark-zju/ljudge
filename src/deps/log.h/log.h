...
#define log_debug(M, ...)
#else
#define log_debug(M, ...) if (debug_level > 5) fprintf(stderr, LOG_H_PREFIX_FORMAT "\33[34mDEBUG\33[39m " M "  \33[90m at %s (%s:%d) \33[39m\n", LOG_H_PREFIX_VALUE, ##__VA_ARGS__, __func__, __FILE__, __LINE__)
#endif
...
#define log_warn(M, ...) if (debug_level >= 0) fprintf(stderr, LOG_H_PREFIX_FORMAT "\33[91mWARN\33[39m  " M "  \33[90m at %s (%s:%d) \33[94merrno: %s\33[39m\n", LOG_H_PREFIX_VALUE, ##__VA_ARGS__, __func__, __FILE__, __LINE__, clean_errno())

#define log_info(M, ...) if (debug_level > 4) fprintf(stderr, LOG_H_PREFIX_FORMAT "\33[32mINFO\33[39m  " M "  \33[90m at %s (%s:%d) \33[39m\n", LOG_H_PREFIX_VALUE, ##__VA_ARGS__, __func__, __FILENAME__, __LINE__)
